...
Basic Options:
 ...
 - `defaultName` (defaults to `Loader.js`) If the package is a single file, rather than a tarball, it will be "extracted" to this file name, set to `false` to disable.
